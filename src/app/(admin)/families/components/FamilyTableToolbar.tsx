...
interface FamilyTableToolbarProps {
    ...
    onSortByChange: (
        value: NonNullable<FamilyQuery["sortBy"]>,
    ) => void;

    sortOrder: NonNullable<FamilyQuery["sortOrder"]>;
    onSortOrderChange: (
        value: NonNullable<FamilyQuery["sortOrder"]>,
    ) => void;
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                    ...
                    >
                        ...
                        <SelectContent>
                            ...
                            <SelectItem value="familyNo">
                                Family No
                            </SelectItem>

                            <SelectItem value="headName">
                                Head Name
                            </SelectItem>
                        </SelectContent>
                    </Select>
