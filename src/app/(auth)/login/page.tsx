    ...
    return (
        <main className="min-h-screen bg-background">
            <div className="mx-auto flex min-h-screen max-w-7xl items-center justify-center p-6 lg:p-10">
                <div className="grid w-full overflow-hidden rounded-3xl border bg-background shadow-sm lg:grid-cols-2 max-lg:max-w-md">
                    {/* Left */}
                    <AuthHero
                    ...
                    {/* Right */}
                    <section className="w-full flex items-center justify-center p-8 lg:p-14">
                        <LoginForm />
                    </section>
                </div>
            </div>
