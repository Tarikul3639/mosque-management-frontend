...
export function Lantern() {
  ...
  return (
    ...
    <div className="relative h-28 w-20">
      {/* glow */}
      <div className="absolute left-1/2 top-1/2 h-28 w-28 -translate-x-1/2 -translate-y-1/2 rounded-full bg-amber-400/25 blur-2xl" />
      ...
      >
        ...
        {/* hanging ring + neck */}
        <circle cx="60" cy="10" r="6" fill="none" stroke={`url(#${id}-gold)`} strokeWidth="3" />
        <rect x="56" y="16" width="8" height="8" rx="2" fill={`url(#${id}-gold)`} />

        {/* dome */}
        <path d="M60 24c-16 0-26 10-28 22h56c-2-12-12-22-28-22z" fill={`url(#${id}-gold)`} />
        <rect x="28" y="46" width="64" height="8" rx="3" fill={`url(#${id}-gold)`} />
        ...
        {/* frame bars */}
        <path d="M52 60l-2 66M68 60l2 66" stroke="#8a5a19" strokeWidth="2" opacity=".5" />
        {/* flame */}
        <ellipse cx="60" cy="100" rx="7" ry="12" fill="#fffbeb" opacity=".95" />

        {/* base */}
        <rect x="34" y="132" width="52" height="8" rx="3" fill={`url(#${id}-gold)`} />
