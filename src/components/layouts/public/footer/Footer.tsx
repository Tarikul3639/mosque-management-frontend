...
export function Footer() {
  return (
    <footer className="bg-muted/20">
      {/* Image */}
      <div className="container mx-auto flex justify-center px-3 pt-10 sm:px-6 lg:px-8 lg:pt-12">
        <Image
      ...
      {/* Content */}
      <div className="container mx-auto border-t px-4 pt-10 pb-6 sm:px-6 lg:px-8 lg:pt-12">
