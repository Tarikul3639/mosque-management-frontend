          ...
          <div className="flex flex-wrap items-center gap-2">
            {PRESETS.map((preset) => (
              <Button
                ...
                onClick={() =>
                  handleDateRangeChange(preset.range(), preset.key)
                }
              >
                {preset.label}
              </Button>
            ...
            {isFiltered && (
              <Button
                ...
                className="text-destructive! hover:bg-destructive/10! hover:text-destructive/90! focus:bg-destructive/10!"
              >
        ...
        {showLoading ? (
          ...
          <div className="grid grid-cols-2 overflow-hidden rounded-xl bg-muted shadow-sm lg:grid-cols-4">
            {stats.map(({ icon: Icon, label, stat, money, filled }, i) => (
              <div
                key={label}
                className={`flex items-center justify-center gap-3 px-4 py-6 sm:gap-4 sm:px-6 sm:py-8 ${
