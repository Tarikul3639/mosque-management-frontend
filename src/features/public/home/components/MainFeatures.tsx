                ...
                <div className="mt-8 grid grid-cols-2 gap-3 sm:gap-4 md:mt-12 md:grid-cols-4 md:gap-5">
                    {FEATURES.map(({ icon: Icon, title, description, href }) => (
                        ...
                        >
                            ...
                            <div className="pointer-events-none absolute -right-10 -top-10 size-28 rounded-full bg-chart-3/5 blur-2xl transition-all duration-300 group-hover:bg-chart-3/10" />
