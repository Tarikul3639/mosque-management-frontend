...
export function MemberCard({ member }: { member: CommitteeMember }) {
    ...
    return (
        ...
        >
            {/* ---------------- Header ---------------- */}
            <div className="relative rounded-t-xl border-b border-border bg-muted/30 px-6 pt-7 pb-6 overflow-hidden">
                <Badge
                    variant="outline"
                ...
                <div className="flex justify-center items-center">
                    ...
                    <Avatar className="size-30 border border-border shadow-sm sm:size-32">
                        <AvatarImage
                            ...
                            alt={member.name}
                        />
                        <AvatarFallback className={`${getAvatarClass(member.name)} text-2xl sm:text-3xl`}>
                ...
                <div className="mt-1.5 flex justify-center">
                    <Badge variant="secondary" className="text-center text-xs font-medium uppercase tracking-wide">
                        {designation}
                    </Badge>
                </div>
            </div>
