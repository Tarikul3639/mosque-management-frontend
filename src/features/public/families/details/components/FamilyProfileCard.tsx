    ...
    <Card>
      <CardContent className="flex flex-col items-center gap-6 p-6 md:flex-row md:items-center">
        <Avatar className="size-24 shrink-0 border border-border">
          ...
          <AvatarFallback
            className={`${getAvatarClass(family.headName)} text-3xl`}
          >
            {getAvatarInitials(family.headName)}
          </AvatarFallback>
        </Avatar>

        <div className="flex flex-col items-center justify-center text-center md:flex-1 md:items-start md:text-left">
