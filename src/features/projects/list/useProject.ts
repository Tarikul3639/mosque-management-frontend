...
export function useProject() {
    ...
    const { data: projectsData, isLoading, isFetching, isError, refetch } = useGetProjectsQuery(query)

    const { data: summaryData, isLoading: isSummaryLoading } = useGetProjectSummaryQuery()
