...
export function GalleryTableActions({ gallery }: GalleryTableActionsProps) {
  ...
  const galleryTitle =
    typeof gallery.title === "string" ? gallery.title : "this gallery"
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {galleryTitle}&quot; and remove its data from the server.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
