...
import { useDeletePaymentMutation, useLazyGetPaymentReceiptQuery } from "@/store/api/payment.api"
...
export const paymentColumns: ColumnDef<Payment>[] = [
...

    {
        ...
        cell: ({ row }) => {
            ...
            const [triggerGetReceipt, { isLoading: isReceiptLoading }] = useLazyGetPaymentReceiptQuery();
                ...
                <>
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem asChild>
                                <button className="w-full flex items-center gap-2" onClick={() => handlePrint()} disabled={isReceiptLoading}>
