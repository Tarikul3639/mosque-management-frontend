        ...
        <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-6">
                <div className="space-y-1">
                    ...
                    <CardDescription>Complete payment and billing details.</CardDescription>
                </div>
                ...
                <div className="space-y-5">
                    ...
                    <InfoRow
                        ...
                        value={
                            <span
                                className={
                                    remainingAmount > 0 ? "font-semibold text-rose-600" : "font-semibold text-emerald-600"
                                }
                            >
...
function LargeStatusBadge({ status }: { status: PaymentStatus }) {
    ...
    return (
        <div className={`rounded-full border px-4 py-1.5 text-base font-bold tracking-wider ${styles[status]}`}>
            {labels[status]}
        </div>
    )
}
