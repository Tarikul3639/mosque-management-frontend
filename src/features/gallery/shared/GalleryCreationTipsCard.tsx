                ...
                <div className="space-y-3">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Use a clear and meaningful gallery title. Add a
                                short description to help visitors understand
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Upload high-quality images with proper
                                orientation. Avoid blurry, duplicated, or
                                unrelated photos.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Set the correct display order so galleries
                                appear in the intended sequence on the website.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Ensure all uploaded images belong to the same
                                event or activity for a consistent gallery.
                            </p>
                        </div>
                    </div>
                </div>
